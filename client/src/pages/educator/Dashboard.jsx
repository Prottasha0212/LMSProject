...
const Dashboard = () => {
  ...
  return dashboardData ? (
    <div className="min-h-screen flex flex-col md:p-8 md:pb-0 p-4 pt-8 pb-0">
      {/* Left-aligned grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-fit">
        {/* Card 1 */}
        <div className="flex items-center gap-3 shadow-card border border-blue-500 p-4 rounded-md w-60">
      ...
      <div>
        ...
        <table className="table-fixed md:table-auto w-full overflow-hideen">
          ...
          <tbody className="text-sm text-gray-500">
            {dashboardData.enrolledStudentsData.map((item,index)=>(
              <tr key={index} className="border-b border-gray-500/20">
                <td className="px-4 py-3 text-center hidden sn:table-cell">
                  {index + 1}</td>
