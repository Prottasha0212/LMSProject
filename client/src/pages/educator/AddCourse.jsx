  ...
  const [lectureDetails,setLectureDetails] = useState(
    {
      ...
      lectureUrl:'',
      isPreviewFree: false,
      //  if true then can priview video without purchasing course
    }
  )
    ...
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        <div className='fex flex-col gap-1'>
          ...
          type="text" placeholder='Type here' className='outline-none md:py-2.5 py-2 px-3 rounded border border-gary-500' required/>
        ...
        <div>
            ...
            <div key={chapterIndex} className="bg-white border rounded-lg mb-4">
              <div className="flex justify-between items-center p-4 border-b">
                <div className='flex items-center'>
                  <img onClick={()=> handleChapter('toggle', chapter.chapterId)} src={assets.dropdown_icon} width ={14} alt="" className={`mr-2 cursor-pointer
          ...
          <div className='flex justify-center itemscenter bg-blue-100 p-2 rounded-lg cursor-pointer'
        ...
        <button type="submit" className='bg-black text-white w-max py-2.5 px-8 rounded mt-4'>
          ADD
        </button>
      </form>
    </div>
