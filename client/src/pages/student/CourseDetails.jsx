   ...
   return courseData ? (
    <>
     ...
     justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      bg-gradient-to-b from-cyan-100/70 to-white'> </div>
       ...
       <div className='max-w-xl x-10 text-gray-500'>
        ...
        text-course-details-heading-large font-semibold text-gray-900'>{courseData.courseTitle}</h1>
          ...
          <div className='p-5'>
            ...
            <div className='flex gap-3 items-center pt-2'>
              <p className='text-gray-800 md:text-4xl text-2xl font-semibold'>
                {currency}{(courseData.coursePrice - courseData.discount * courseData.coursePrice
                /100).toFixed(2)}
              </p>
