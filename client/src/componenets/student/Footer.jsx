    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
        <div className='flex flex-col md:items-start items-center w-full'>
          <img src={assets.logo} alt="logo" className='w-10 h-10 lg:w-12 lg:h-12 cursor-pointer'/>
          <h1 className="text-xl font-semibold text-white">LMS Project</h1>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 @ MStack. All Right Reserved.</p>
    </footer>
  )
}
