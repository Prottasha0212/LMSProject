  ...
  return (
    <div className='pd-14 px-8 md:px-0'>
      ...
      <p className='md:text-base text-gray-500 mt-3'>Hear from our learners as they share their journeys of transformation,
        success, and how our <br/> courses have empowered them to achieve their goals.
      </p>
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3  gap-8 mt-14'>

        {dummyTestimonial.map((testimonial, index) => (
          <div key={index} className='text-sm text-left border-gray-500/30
          pb-6 rounded-lg bg-white shadow-[0px_4px_15[x_0px] shadow-black/5 overflow-hidden'>
